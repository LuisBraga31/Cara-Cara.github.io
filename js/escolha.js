...
function escolha() {
    ...
    image.src = 'img/cards/iza.JPG';
    } else if(seletor.value === "Larissa Manoela") {
    image.src = 'img/cards/larissa_manoela.JPG';
    } else if(seletor.value === "Luan Santana") {
    image.src = 'img/cards/luan.JPG';
    } else if(seletor.value === "Maisa") {
    image.src = 'img/cards/maisa.JPG';
    } else if(seletor.value === "Neymar") {
    image.src = 'img/cards/neymar.JPG';
    } else if(seletor.value === "Rodrigo Faro") {
    image.src = 'img/cards/rodrigo.JPG';
    } else if(seletor.value === "Silvio Santos") {
    image.src = 'img/cards/silvio_santos.JPG';
    } else if(seletor.value === "Thiaguinho") {
    image.src = 'img/cards/thiaguinho.JPG';
    } else if(seletor.value === "Tata Werneck") {
